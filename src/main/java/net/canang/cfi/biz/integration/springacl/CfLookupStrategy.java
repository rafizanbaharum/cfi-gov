...
public class CfLookupStrategy implements LookupStrategy {
     ...
     */
    @Deprecated
    public CfLookupStrategy(DataSource dataSource, AclCache aclCache,
    ...
    private class ProcessResultSet implements ResultSetExtractor<Set<Long>> {
        ...
        /**
         * Implementation of {@link ResultSetExtractor#extractData(java.sql.ResultSet)}.
         * Creates an {@link Acl} for each row in the {@link java.sql.ResultSet} and
         ...
         *
         * @param rs The {@link java.sql.ResultSet} to be processed
