 ...
 *
 */
@Component("distributionControl_approve_ST")
public class DistributionControlApproveTask extends ControlTaskSupport {

    private static final Logger log = Logger.getLogger(DistributionControlApproveTask.class);
