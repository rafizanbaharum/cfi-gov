 ...
 */
@Table(name = "CF_SPRT_CODE")
@Entity(name = "CfSubProjectCode")
public class CfSubProjectCodeImpl implements CfSubProjectCode, Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "ID", nullable = false)
    @GeneratedValue(generator = "SEQ_CF_SPRT_CODE")
    @SequenceGenerator(name = "SEQ_CF_SPRT_CODE", sequenceName = "SEQ_CF_SPRT_CODE", allocationSize = 1)
    private Long id;
