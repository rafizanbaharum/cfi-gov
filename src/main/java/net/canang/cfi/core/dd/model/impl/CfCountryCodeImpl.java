 ...
 */
@Table(name = "CF_CNTY_CODE")
@Entity(name = "CfCountryCode")
public class CfCountryCodeImpl implements CfCountryCode, Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "ID", nullable = false)
    @GeneratedValue(generator = "SEQ_CF_CNTY_CODE")
    @SequenceGenerator(name = "SEQ_CF_CNTY_CODE", sequenceName = "SEQ_CF_CNTY_CODE", allocationSize = 1)
    private Long id;
