 ...
 */
@Table(name = "CF_PRJT_CODE")
@Entity(name = "CfProjectCode")
public class CfProjectCodeImpl implements CfProjectCode, Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "ID", nullable = false)
    @GeneratedValue(generator = "SEQ_CF_PRJT_CODE")
    @SequenceGenerator(name = "SEQ_CF_PRJT_CODE", sequenceName = "SEQ_CF_PRJT_CODE", allocationSize = 1)
    private Long id;
