 ...
 */
@Table(name = "CF_INVC_ITEM")
@Entity(name = "CInvoiceItem")
public class CfInvoiceItemImpl implements CfInvoiceItem, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CfInvoiceItemImpl)) return false;

        CfInvoiceItemImpl that = (CfInvoiceItemImpl) o;
